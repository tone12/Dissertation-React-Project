let helpers =  {
  ...
  getRandomName : function() {
    ...
    var nouns = ['women', 'men', 'children', 'teeth', 'feet', 'people', 'leaves', 'mice', 'geese', 'halves', 'knives', 'wives', 'lives', 'loaves', 'potatoes', 'tomatoes', 'cacti', 'nuclei', 'syllabuses', 'analyses', 'diagnoses', 'thesis', 'crisis', 'phenomena', 'criteria', 'data'];
